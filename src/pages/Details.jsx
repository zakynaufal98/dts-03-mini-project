      ...
      {isPlay ? (<Embed />) :
        (<div className="flex items-center">
          <div className="absolute px-4 max-w-[50%] max-h-fit mx-4">
            <h1 className="text-xs text-gray-400 font-semibold sm:text-md">{movies.title}</h1>
            <p className="text-xs overflow-hidden py-2 text-justify leading-4 max-h-14 sm:text-md">{movies.overview}</p>
